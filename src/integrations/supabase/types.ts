  ...
  public: {
    Tables: {
      ...
      lead_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "lead_events_cliente_id_fkey";
            columns: ["cliente_id"];
            isOneToOne: false;
            referencedRelation: "profiles";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "lead_events_comercio_id_fkey";
            columns: ["comercio_id"];
            isOneToOne: false;
            referencedRelation: "comercios";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "lead_events_producto_id_fkey";
            columns: ["producto_id"];
            isOneToOne: false;
            referencedRelation: "productos";
            referencedColumns: ["id"];
    ...
    Functions: {
      ...
      create_pedido: {
        Args: {
          ...
          p_direccion_entrega: Json | null;
          p_items: Json;
          p_modalidad: string;
          p_notas_cliente: string | null;
        };
        Returns: string;
      };
      ...
      is_comercio_member: {
        Args: { p_comercio_id: string; p_roles?: string[] | null; p_user_id: string };
        Returns: boolean;
      };
      get_my_profile: {
        Args: never;
