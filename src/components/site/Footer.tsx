  ...
  return (
    <footer className="mt-24 border-t bg-muted/30">
      <div className="container mx-auto grid gap-10 px-4 py-12 md:grid-cols-4">
        <div>
          ...
          <p className="mt-3 text-sm text-muted-foreground">
            El marketplace de tu barrio. Descubrí comercios y productos cerca tuyo.
          </p>
        </div>
        <div>
          <h4 className="mb-3 text-sm font-semibold">Explorar</h4>
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li><Link to="/search" className="hover:text-foreground">Buscar</Link></li>
            <li><Link to="/map" className="hover:text-foreground">Mapa</Link></li>
          </ul>
        </div>
        <div>
      ...
      <div className="border-t py-4 text-center text-xs text-muted-foreground">
        © {new Date().getFullYear()} cerca. Hecho con cariño.
      </div>
    </footer>
  );
}
