...
7. Probar con el propietario de comercio: aceptar -> preparar -> listo -> entregar; y rechazar/cancelar verificando que el stock se repone.
8. Verificar como superadministrador: usuarios, tres comercios piloto, estados y `audit_events`.
...
El aprovisionador crea exactamente dos cuentas de operación: un superadministrador y un propietario para tres comercios piloto. Es idempotente por correo y slug, no imprime contraseñas y se debe ejecutar una sola vez en el entorno de piloto, con credenciales autorizadas de Supabase.
